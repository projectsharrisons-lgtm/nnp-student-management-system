...
def list_students():
    ...
    return render_template('students/list.html', students=students, pagination=pagination, search=search)
...
def delete_student(id):
    ...
    try:
        ...
        db.session.rollback()
        flash('Cannot delete student due to active fee or examination relations.', 'error')
    return redirect(url_for('students.list_students'))
